...
def add_endpoint(
    ...
    method: str = typer.Option(..., "--method", "-m", help="The HTTP method for the API endpoint"),
    # headers: Optional[str] = typer.Option(None, "--headers", "-h", help="The headers for the API endpoint"),
    check_interval: str = typer.Option("5m", "--check-interval", "-c", help="The check interval for the API endpoint"),
):
